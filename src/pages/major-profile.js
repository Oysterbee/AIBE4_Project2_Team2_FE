...
wrap.innerHTML = `
    ...
    <nav class="mj-tabs">
      <button class="mj-tab" data-tab="profile">내 프로필</button>
      <button class="mj-tab" data-tab="request">인증 현황</button>
      <button class="mj-tab" data-tab="interviews">받은 인터뷰</button>
